...
def set_options(model, l_mpi, l_gdf=True):
    ...
    option_pars = {
        ...
        'l_B0_test':     False,# Z-depend of Bz(r=0) single exponential 
        ...
        'l_tube_pair_test':   False,# pair of identical flux tubes
        'l_tube_pair_test_2':   False,# pair of opposite flux tubes
        'l_singletube':   False,# single flux tube
    ...
    if model['model'] == 'tutu':
        option_pars['l_ambB']            = True
        option_pars['l_B0_expz']         = True
        option_pars['l_tube_pair_test']  = True
        option_pars['l_atmos_val3c_mtw'] = True
    if model['model'] == 'loop':
        option_pars['l_ambB']            = True
        option_pars['l_B0_expz']         = True
        option_pars['l_tube_pair_test_2']  = True
        option_pars['l_atmos_val3c_mtw'] = True
    if model['model'] == 'singletube':
        option_pars['l_ambB']            = True
        option_pars['l_B0_expz']         = True
        option_pars['l_single']          = True
        option_pars['l_atmos_val3c_mtw'] = True
    if model['model'] == 'mhs_test':
        option_pars['l_single']          = True
#        option_pars['l_mfe']             = True
        option_pars['l_B0_expz']         = True
        option_pars['l_atmos_val3c_mtw'] = True
    if model['model'] == 'obs_test':
#        option_pars['l_single']          = True
#        option_pars['l_mfe']             = True
#        option_pars['l_B0_expz']         = True
        option_pars['l_B0_test']         = True
        option_pars['l_atmos_val3c_mtw'] = True
    if l_mpi:
